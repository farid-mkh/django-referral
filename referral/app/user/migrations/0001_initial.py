    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', models.CharField(error_messages={'unique': 'A user with that mobile number already exists.'}, max_length=50, unique=True, validators=[user.models.UnicodeMobileNumberValidator()], verbose_name='Mobile Number')),
